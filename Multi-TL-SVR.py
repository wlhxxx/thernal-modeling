...
def model_score(model, x, y):
    cv = ShuffleSplit(n_splits=10, train_size=0.2, test_size=0.8, random_state=29)
...
writer = pd.ExcelWriter('Multi-TL-SVR_score.xlsx')
...
model_scores_pd.to_excel(writer, sheet_name='TL-SVR')
writer.save()
