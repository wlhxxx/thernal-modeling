...
RF = RandomForestRegressor(n_estimators=250, max_depth=11)
regr = MultiOutputRegressor(RF)
...
RF_score = model_score(regr, data_prepard, data_labels)
endtime = datetime.datetime.now()
print(endtime - starttime)

writer = pd.ExcelWriter('Multi-RF_score.xlsx')

model_scores = RF_score
...
model_scores_pd.to_excel(writer, sheet_name='RF')
writer.save()
